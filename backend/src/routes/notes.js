...
const { getUserNotes, createUserNote, deleteUserNote, fetchUserNoteContent, saveUserNoteContent, updateNotePermission, fetchNotePermission, pinUserNote } = require('../controllers/notes');
const router = Router();
...
router.delete('/delete-notes', userAuth, fetchNotePermValidation, validationMiddleware, deleteUserNote);
